...
- **Magnitude-based Pruning**: Loại bỏ các liên kết có giá trị tuyệt đối nhỏ nhất.
- **Structured Pruning**: Loại bỏ toàn bộ các khối hoặc lớp của mô hình.
- **Iterative Pruning**: Thực hiện Pruning theo từng bước, mỗi bước loại bỏ một số liên kết và huấn luyện lại mô hình.
- **Dynamic Pruning**: Thực hiện Pruning trong quá trình huấn luyện, loại bỏ các liên kết không cần thiết ngay lập tức.
